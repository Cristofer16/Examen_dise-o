...
@section('estilos')
    <link rel="stylesheet" href="/css/user/registrar.css">
@stop
        ...
        <div class="container">
            ...
            <form action="{{ route('user_validar_sesion') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="contraseña" placeholder="Introduza su contraseña" name="contraseña">
                </div>
                <div class="mb-3">
